...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Tietzcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"tietzcointools.com", "dnsseed.tietzcointools.com"},
    {"tietzcoinpool.org", "dnsseed.tietzcoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"tietzcointools.com", "testnet-seed.tietzcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Tietzcoin is probably already running."), addrBind.ToString().c_str());
        else
